...
public abstract class EntityLiving extends Entity
{
    ...
    public static int stopBleedAfterTicks;
    public int ticksActuallyBleeding;
    public boolean isBleeding;
    public boolean instantBleed;
    ...
    public EntityLiving(World world)
    {
        ...
        field_46018_e = new EntityMoveHelper(this, moveSpeed);
        ...
        isBleeding = false;
        ticksNoBlood = 0;
        stopBleedAfterTicks = 80;
        ticksActuallyBleeding = 0;
        instantBleed = false;
    }
    ...
    {
        if (damagesource == DamageSource.outOfWorld && isBleeding)
        {
            isBleeding = false;
        }
        else if (damagesource.damageType != "inFire" && damagesource.damageType != "onFire" && damagesource.damageType != "lava" && damagesource.damageType != "inWall" && damagesource.damageType != "drown" && damagesource.damageType != "starve" && damagesource.damageType != "fall" && damagesource.damageType != "outOfWorld" && damagesource.damageType != "generic" && damagesource.damageType != "explosion" && damagesource.damageType != "magic" && damagesource.damageType != "fireball" && damagesource.damageType != "thrown" && damagesource.damageType != "indirectMagic")
        {
            ...
            if (entity instanceof EntityPlayer)
            {
                ...
                if (itemstack != null && (mod_Epixcrafted.canInstantBleed && !(this instanceof EntitySkeleton) && !(this instanceof EntityCreeper) && !(this instanceof EntityPlayer) && itemstack.itemID == Item.swordDiamond.shiftedIndex || itemstack.itemID == Item.swordSteel.shiftedIndex || itemstack.itemID == Item.swordStone.shiftedIndex || itemstack.itemID == Item.swordGold.shiftedIndex || itemstack.itemID == Item.swordWood.shiftedIndex))
                {
                    instantBleed = true;
                }
            }
            if (!(this instanceof EntitySkeleton) && !(this instanceof EntityCreeper) && !(this instanceof EntityPlayer))
            {
                isBleeding = true;
                ticksActuallyBleeding = 0;
                ticksNoBlood = 0;
            }
            ProduceBlood(mod_Epixcrafted.particlesFirstHit);
        }
        ...
        if (flag)
        {
            ...
            if (entity1 != null)
            {
                ...
                double d1;
                for (d1 = entity1.posZ - posZ; d * d + d1 * d1 < 0.0001D; d1 = (Math.random() - Math.random()) * 0.01D)
                {
                    d = (Math.random() - Math.random()) * 0.01D;
                }

                attackedAtYaw = (float)((Math.atan2(d1, d) * 180D) / 3.1415927410125732D) - rotationYaw;
                knockBack(entity1, i, d, d1);
            }
            else
            {
    ...
    {
        return !worldObj.multiplayerWorld;
    }
    ...
    protected void func_46014_aS()
    {
        entityAge++;
        despawnEntity();
        if (field_46020_bQ != null && !field_46020_bQ.isEntityAlive())
        {
            field_46020_bQ = null;
        }
    ...
    public void updateBlood()
    {
        if (!isDead)
        {
            if (isBleeding && ticksNoBlood > 5 || instantBleed && !(this instanceof EntitySkeleton))
            {
                if (instantBleed)
                {
                    ticksActuallyBleeding++;
                }
                if (ticksActuallyBleeding < (stopBleedAfterTicks / 4) * 3)
                {
                    ProduceBlood(mod_Epixcrafted.particlesOnBleed);
                    if (mod_Epixcrafted.bleedingDamageAllowed)
                    {
                        if ((this instanceof EntityPlayer) || (this instanceof EntityPlayerSP) && mod_Epixcrafted.bleedingDamagePlayerAllowed)
                        {
                            damageEntity(DamageSource.generic, mod_Epixcrafted.bleedingDamageAmount);
                        }
                        else if (!(this instanceof EntityPlayer) && !(this instanceof EntityPlayerSP))
                        {
                            damageEntity(DamageSource.generic, mod_Epixcrafted.bleedingDamageAmount);
                        }
                    }
                ...
                {
                    ProduceBlood(mod_Epixcrafted.particlesOnLowBleed);
                }
                ticksActuallyBleeding += ticksNoBlood;
                ticksNoBlood = 0;
            }
            else
            {
            ...
            if (instantBleed && ticksActuallyBleeding > stopBleedAfterTicks / 2)
            {
                instantBleed = false;
            }
            if (isBleeding)
            {
                EntityLiving _tmp = this;
                if (ticksActuallyBleeding >= stopBleedAfterTicks)
                {
                    instantBleed = false;
                    ticksActuallyBleeding = 0;
                    isBleeding = false;
            ...
            if ((this instanceof EntityPlayer) || (this instanceof EntityPlayerSP))
            {
                if (health < 4 && ticksNoBlood > 7 || health < 10 && ticksNoBlood > 15)
                {
                    ProduceBlood(10);
                    ticksNoBlood = 0;
                }
    ...
    public void ProduceBlood(int i)
    {
        ...
        if (this instanceof EntitySkeleton)
        {
            for (int j = 0; j < i / 2; j++)
            {
                minecraft.effectRenderer.addEffect(new EntityReddustFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 1.0F, 1.0F, 1.0F));
            }
        }
        else if (this instanceof EntityDragon)
        {
            ...
            {
                minecraft.effectRenderer.addEffect(new EntityBloodFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F - 1.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 1.0F, 0.0F, 0.0F));
                minecraft.effectRenderer.addEffect(new EntityReddustFX(worldObj, posX + (double)(random.nextFloat() % (mod_Epixcrafted.spreadRateXZ * mod_Epixcrafted.spreadRateIncreasedDragon) - (mod_Epixcrafted.spreadRateXZ * mod_Epixcrafted.spreadRateIncreasedDragon) / 2.0F), posY + (double)(random.nextFloat() % 0.3F) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % (mod_Epixcrafted.spreadRateXZ * mod_Epixcrafted.spreadRateIncreasedDragon) - (mod_Epixcrafted.spreadRateXZ * mod_Epixcrafted.spreadRateIncreasedDragon) / 2.0F), 1.0F, 1.0F, 1.0F));
            }
        }
        else if (this instanceof EntityCreeper)
        {
            for (int l = 0; l < i; l++)
            {
                minecraft.effectRenderer.addEffect(new EntityReddustFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 0.15F, 0.15F, 0.15F));
            }
        }
        else if (this instanceof EntityEnderman)
        {
            for (int i1 = 0; i1 < i; i1++)
            {
            	minecraft.effectRenderer.addEffect(new EntityBloodyFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 1.0F, 0.0F, 0.658F, 1.0F, 1.0F, 1.0F));
                minecraft.effectRenderer.addEffect(new EntityBloodFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 1.0F, 0.0F, 0.658F));
            }
        }
        else if (this instanceof EntityMagmaCube)
        {
            ...
            {
            	minecraft.effectRenderer.addEffect(new EntityBloodyFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 1.0F, 0.5F, 0.0F, 1.0F, 1.0F, 1.0F));
                minecraft.effectRenderer.addEffect(new EntityBloodFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 1.0F, 0.5F, 0.0F));
            }
        }
        else if (this instanceof EntitySlime)
        {
            ...
            {
            	minecraft.effectRenderer.addEffect(new EntityBloodyFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 0.0F, 1.0F, 0.2F, 1.0F, 1.0F, 1.0F));
                minecraft.effectRenderer.addEffect(new EntityBloodFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 0.0F, 1.0F, 0.2F));
            }
        }
        else if (this instanceof EntityBlaze)
        {
        ...
        else if ((this instanceof EntitySpider) || (this instanceof EntityCaveSpider))
        {
            for (int i2 = 0; i2 < i; i2++)
            {
            	minecraft.effectRenderer.addEffect(new EntityBloodyFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 0.0F, 0.6F, 0.0F, 1.0F, 1.0F, 1.0F));
                minecraft.effectRenderer.addEffect(new EntityBloodFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 0.0F, 0.6F, 0.0F));
            }
        }
        else if (this instanceof EntitySilverfish)
        {
        ...
        else if (this instanceof EntityPlayer)
        {
            ...
            {
            	minecraft.effectRenderer.addEffect(new EntityBloodyFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F - 1.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F));
                minecraft.effectRenderer.addEffect(new EntityBloodFX(worldObj, posX + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), ((posY + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateY)) - (double)(mod_Epixcrafted.spreadRateY / 2.0F)) + (double)(height / 2.0F - 1.0F), posZ + (double)(random.nextFloat() % mod_Epixcrafted.spreadRateXZ - mod_Epixcrafted.spreadRateXZ / 2.0F), 1.0F, 0.0F, 0.0F));
            }
        }
        else if (!(this instanceof EntityGhast) && !(this instanceof EntitySnowman))
        {
